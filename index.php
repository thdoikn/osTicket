...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Format::htmlchars($lpb_asset); ?>style.css<?php echo Format::asset_cache_qs(); ?>">
    <script defer src="<?php echo Format::htmlchars($lpb_asset); ?>lpb-chrome-nav.js<?php echo Format::asset_cache_qs(); ?>"></script>
</head>
<body>
<?php
$lpb_active = 'home';
...
?>
    ...
    <section class="whatsapp-section">
        <div class="whatsapp-background">
            <img src="<?php echo Format::htmlchars($lpb_asset); ?>asset/IstanaGarudaView.webp" alt="" class="whatsapp-bg-img">

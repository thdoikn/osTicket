...
(function () {
    var translations = {
        id: {
            ...
            ticketMessagePostedSuccess: 'Pesan berhasil dikirim.',
            ...
            fieldPhoneExt: 'Ekst',
            ticketsListBreadcrumb: 'Daftar tiket',
            ticketsListPageTitle: 'Daftar tiket Anda',
            ticketsListPageDesc: 'Lihat dan kelola tiket laporan yang telah Anda kirim.',
            ticketsListSearch: 'Cari',
            ticketsListHelpTopic: 'Topik bantuan',
            ticketsListAllHelpTopics: '— Semua topik bantuan —',
            ticketsListClearFilters: 'Hapus semua filter dan urutan',
            ticketsListHeading: 'Tiket',
            ticketsListOpen: 'Terbuka',
            ticketsListClosed: 'Tertutup',
            ticketsListSearchResults: 'Hasil pencarian:',
            ticketsListShowing: 'Menampilkan',
            ticketsListAbout: 'sekitar',
            ticketsListOf: 'dari',
            ticketsListCaptionOpenTickets: 'Tiket terbuka',
            ticketsListCaptionClosedTickets: 'Tiket tertutup',
            ticketsListCaptionAllTickets: 'Semua tiket',
            ticketsSortByTicketId: 'Urutkan nomor tiket',
            ticketsSortByDate: 'Urutkan tanggal',
            ticketsSortByStatus: 'Urutkan status',
            ticketsSortBySubject: 'Urutkan subjek',
            ticketsSortByDepartment: 'Urutkan departemen',
            ticketsThTicketNum: 'Nomor tiket',
            ticketsThCreateDate: 'Tanggal dibuat',
            ticketsThStatus: 'Status',
            ticketsThSubject: 'Subjek',
            ticketsThDepartment: 'Departemen',
            ticketsListEmpty: 'Tidak ada data yang cocok dengan pencarian Anda.',
            ticketsListPageLabel: 'Halaman'
        },
        en: {
            navHome: 'Home',
            navReport: 'Report',
            ...
            ticketMessagePostedSuccess: 'Message posted successfully.',
            ...
            fieldPhoneExt: 'Ext',
            ticketsListBreadcrumb: 'Your tickets',
            ticketsListPageTitle: 'Your tickets',
            ticketsListPageDesc: 'View and manage the report tickets you have submitted.',
            ticketsListSearch: 'Search',
            ticketsListHelpTopic: 'Help Topic',
            ticketsListAllHelpTopics: '— All Help Topics —',
            ticketsListClearFilters: 'Clear all filters and sort',
            ticketsListHeading: 'Tickets',
            ticketsListOpen: 'Open',
            ticketsListClosed: 'Closed',
            ticketsListSearchResults: 'Search results:',
            ticketsListShowing: 'Showing',
            ticketsListAbout: 'about',
            ticketsListOf: 'of',
            ticketsListCaptionOpenTickets: 'Open Tickets',
            ticketsListCaptionClosedTickets: 'Closed Tickets',
            ticketsListCaptionAllTickets: 'All Tickets',
            ticketsSortByTicketId: 'Sort by ticket number',
            ticketsSortByDate: 'Sort by date',
            ticketsSortByStatus: 'Sort by status',
            ticketsSortBySubject: 'Sort by subject',
            ticketsSortByDepartment: 'Sort by department',
            ticketsThTicketNum: 'Ticket #',
            ticketsThCreateDate: 'Create Date',
            ticketsThStatus: 'Status',
            ticketsThSubject: 'Subject',
            ticketsThDepartment: 'Department',
            ticketsListEmpty: 'Your query did not match any records.',
            ticketsListPageLabel: 'Page'
        }
    };
    var registerFields = {
        id: {
